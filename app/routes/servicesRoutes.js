...
exports.list = function list(req, res) {
	...
	servicesdbHelper.selectAll(function(err, results) {
...
exports.getByKey = function getByKey(req, res) {
	...
	servicesdbHelper.selectByKey(key, function(err, result) {
...
exports.add = function add(req, res) {
	...
	servicesdbHelper.insert(data, function(err, newObj) {
...
exports.update = function update(req, res) {
	...
	servicesdbHelper.update(id, data, function(err, num) {
...
exports.del = function del(req, res) {
	...
	servicesdbHelper.del(id, function(err, num) {
